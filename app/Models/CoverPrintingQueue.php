...
class CoverPrintingQueue extends Model
{
    protected $table = 'cover_printing_queues';
    ...
    {
        return $this->belongsTo(PrintingQueue::class, ['order_id', 'ordered_book_id'], ['order_id', 'ordered_book_id']);
    }
